...
const querySearch = async (query, limit) => {
    const response = await axios.get(`${SHEIN_API}products/search?keywords=${query}&language=en&country=US&currency=USD&sort=7&limit=${limit}&page=1`, {
        headers: {
